...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>View Faculties | Phasor Academy - Responsive Bootstrap 5 Admin Dashboard</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">View Faculties</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><div class="col-auto">
                                                                    <img data-dz-thumbnail="" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['faculty_profile']); ?>" class="avatar-sm rounded bg-light" alt="">
                                                                </div>
                                                            </td>
                                                            <td><?php echo $row['faculty_name']; ?></td>
                                                            <td><?php echo $row['faculty_desc']; ?></td>
                                                            <td><?php echo $row['faculty_cat']; ?></td>
                                                            <td><?php echo $row['date']; ?></td>
                                                            <td>
                                                                <a href="delete_faculty.php?f_id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
