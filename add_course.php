                                            ...
                                            <div class="col-xl-6">
                                                <form action="insert_course.php" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="course_title" name="course_title" class="form-control" placeholder="Enter project name">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="course_desc" class="form-label">Course Description</label>
                                                        <textarea class="form-control" id="course_desc" name="course_desc" rows="5" placeholder="Enter some brief about project.."></textarea>
                                                    </div>
