...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>View Branches | Phasor Academy - Responsive Bootstrap 5 Admin Dashboard</title>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="delete_branch.php?b_id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
