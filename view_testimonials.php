...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>View Testimonials | Phasor Academy - Responsive Bootstrap 5 Admin Dashboard</title>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><div class="col-auto">
                                                                    <img data-dz-thumbnail="" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['photo']); ?>" class="avatar-sm rounded bg-light" alt="">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <a href="delete_testimonial.php?t_id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
