...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>View Images | Phasor Academy - Responsive Bootstrap 5 Admin Dashboard</title>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="col-auto">
                                                                    <img data-dz-thumbnail="" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" class="avatar-lg rounded bg-light" alt="">
                                                                </div>
                                                            </td>
                                                            <td><?php echo $row['date']; ?></td>
                                                            <td>
                                                                <a href="delete_image.php?i_id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
